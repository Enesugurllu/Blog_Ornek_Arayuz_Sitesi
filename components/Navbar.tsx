...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-20 py-4 bg-[#0f172a]/95 backdrop-blur-sm border-b border-gray-800">
      {/* Logo */}
      <div className="flex items-center">
        <Link href="/" className="flex items-center">
          <span className="text-2xl font-bold text-blue-500">Genz</span>
        </Link>
      </div>
      ...
      <div className="hidden md:flex items-center space-x-8">
        ...
        <div className="relative group"
          ...
          <button className="text-gray-300 hover:text-blue-500 text-base font-medium pb-2 flex items-center">
            Home
              ...
              <div className="py-2">
                {menuItems.home.map((item: string, index: number) => (
                  <Link
                    key={index}
                    href="#"
                    className="block px-4 py-1.5 text-xs text-gray-300 hover:bg-gray-800 hover:text-blue-500 first:rounded-t-xl last:rounded-b-xl"
                  >
                    {item}
                  </Link>
                ))}
        ...
        <div className="relative group"
             ...
             onMouseLeave={handleMouseLeave}>
          <Link href="/hakkimda" className="text-gray-300 hover:text-blue-500 text-base font-medium pb-2 flex items-center">
            About Me
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
            </svg>
        ...
        {/* Contact - No Dropdown */}
        <Link href="/contact" className="text-gray-300 hover:text-blue-500 text-base font-medium">
          Contact
        </Link>
      </div>
      ...
      <div className="flex items-center space-x-6">
        ...
        {/* Subscribe Butonu */}
        <button className="bg-cyan-400 text-white px-6 py-2 rounded-lg hover:bg-cyan-500 transition duration-300 text-base font-medium">
          Subscribe
        </button>
      </div>
    </nav>
